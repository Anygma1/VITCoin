  ...
  <body>
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        ...
        $blah = $_GET['fail'];
        if($blah==1){
          echo '<p style="text-align: left; margin:0 135px; font-size: 12px; color: red;">Insufficient balance in the wallet. Click<a href="addmoney.php"> here </a>to add VITCoins.</p>';
        }
        else{}
        ?>
