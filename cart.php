...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Shopping Cart || GadgetDuniya!</title>
  ...
  <body>
    ...
    <nav class="top-bar" data-topbar role="navigation">
      <ul class="title-area">
        <li class="name">
          <h1><a href="index.php">GadgetDuniya!</a></h1>
        </li>
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        ...
        <footer style="margin-top:10px;">
           <p style="text-align:center; font-size:0.8em;clear:both;">&copy; GadgetDuniya! All Rights Reserved.</p>
        </footer>
