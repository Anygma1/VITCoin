          ...
          <div class="row">
            ...
            <div class="small-8 columns end">
              <?php
                ...
                if($result) {
                  $obj = $result->fetch_object();
                  echo '<input type="text" id="right-label" placeholder="Enter first name" name="fname">';
                  ...
                  echo '<input type="text" id="right-label" placeholder="Enter last name" name="lname">';
                  ...
                  echo '</div>';
                  echo '<div class="small-8 columns end">';
                  echo '<input type="text" id="right-label" placeholder="Enter address" name="address">';
                  ...
                  echo '</div>';
                  echo '<div class="small-8 columns end">';
                  echo '<input type="text" id="right-label" placeholder="Enter city" name="city">';
                  echo '</div>';
                  echo '</div>';
                  ...
                  echo '<input type="text" id="right-label" placeholder="Enter pin-code" name="pin">';
                  ...
                  echo '<input type="email" id="right-label" placeholder="Enter e-mail address" name="email">';
