      ...
      <div class="row">
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="email" id="right-label" placeholder="Enter email id" name="email">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
          ...
          <div class="row">
            <div class="small-4 columns">
              <label for="right-label" class="right inline">Security question: What is your VIT lab password? (In case you forget your password)</label>
            </div>
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Enter answer" name="answer">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
